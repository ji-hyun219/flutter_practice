...
왼쪽 사이드바에 `프로덕션`이 있다 클릭 > `새 버전 만들기` > 확실하진 않지만 모든 걸 끝냈고 마지막으로 `변경사항 검토?` 를 눌러야 심사가 된다. 아래 사진 보면 검색창 옆에 `변경사항 검토` 가 있었던 것 같다.
<img width="1119" alt="스크린샷 2023-05-26 오후 9 41 08" src="https://github.com/ji-hyun219/flutter_practice/assets/91349474/d7101aa0-ada5-4372-935d-bea6e9a9c33a">


### iOS
위에 메뉴 중 App Store 클릭 > `iOS 앱` 옆에 (+) 파란 버튼이 있음 > 그걸 누르고 빌드 선택해서 올리고...
